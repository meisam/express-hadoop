...
def usage():
	print "Usage: reshape.py [--help] [--format formatFile [--input inputFile]]"
...
def main():
	...
	try:
		opts, args = getopt.getopt(sys.argv[1:], "hf:i:", ["help", "format", "input"])
	...
	#print keywords,delimiters,columns
